...
Плюс живой мониторинг друзей в Steam и послематчевая аналитика Dota 2. Можно чекать активность даже по вкладкам браузера, а не только по открыт/закрыт ли браузер
...
в несколько раз больше, чем весь ChronoTrack.
